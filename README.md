...
![badge](https://img.shields.io/badge/version-0.2.1-blue)
...
[files]
question_file = "chitchat/data/questions.csv"
...
streamlit run chitchat/main.py
```

<p align="center">
<img src="img/streamlit.jpg" width="90%">
</p>

- Specify the document path (`question_file`, `answer_file` and `score_file`) in `config.ini`.
- Modify `chitchat/data/questions.csv` if needed for additional questions.
...
- [x] Streamlit application with multiple file upload
- [ ] Better pdf parsing
...
- [Streamlit Library](https://docs.streamlit.io/library/api-reference/widgets/st.file_uploader)
